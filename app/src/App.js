...
//Contains the logic to delete the taks from the Datastore
  ...
  const deleteTask = useCallback(() => {
    setDeleting(true);
    axios
      .delete(`/server/ToDoList/${id}`)     //Ensure that 'to_do_list_function' is the package name of your function. If your Advanced I/O function is coded in the Java environment, replace "to_do_list_function" with "ToDoList".
      .then((response) => {
        const {
          data: {
            todoItem: { id }
...
function App() {
  ...
  useEffect(() => {
    if (fetchState !== 'fetched') {
      axios
        .get('/server/ToDoList/all', {   //Ensure that 'to_do_list_function' is the package name of your function. If your Advanced I/O function is coded in the Java environment, replace "to_do_list_function" with "ToDoList".
...
/// This segment contains the logic for creating a new task
  ...
  const createTodo = useCallback(
    (event) => {
      ...
      setSubmitting(true);
      axios
        .post('/server/ToDoList/add', {    //Ensure that 'to_do_list_function' is the package name of your function. If your Advanced I/O function is coded in the Java environment, replace "to_do_list_function" with "ToDoList".
          notes
        })
        .then((response) => {
          const {
